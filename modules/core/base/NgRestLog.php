 ...
 */
class NgRestLog extends \luya\admin\ngrest\base\NgRestModel {
    ...
    public function ngRestScopes() {
        return [
            ['list', ['user_id', 'timestamp_create', 'is_update', 'is_insert', 'table_name']],
//            [['create', 'update'], ['user_id', 'timestamp_create', 'route', 'api', 'is_update', 'is_insert', 'attributes_json', 'attributes_diff_json', 'pk_value', 'table_name', 'is_delete']],
    ...
    public function getUser() {
        return $this->hasOne(\luya\admin\models\User::class, ['id' => 'user_id']);
    }
