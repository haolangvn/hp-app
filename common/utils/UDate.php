...
class UDate {
    ...
    public static function getStringVN($time) {
...
//        $stringdate = $dayname . $dayno . " tháng " . $day[2] . " năm " . $day[3];
        ...
        return $dayname . self::getString($time);
    }

    public static function getString($time, $fm = 'd-m-Y') {
        return $time == 0 ? '' : gmdate($fm, $time + 3600 * 7);
    }

    /**
     * Chuyen doi tu String den Int
     * @param type $str format: (Y-m-d H:i:s)
     * @return int
     */
